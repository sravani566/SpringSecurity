...
public class EventOrganisationApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
     SimpleDateFormat fmt=new SimpleDateFormat("dd/MM/yyyy");
		Date d1=fmt.parse("13/01/2021");
		Date d2=fmt.parse("14/01/2021");
		Date d3=fmt.parse("15/02/2021");
		
		Event e1=new Event("Singing", "Secunderabad", d1, 10, 20);
		Event e2=new Event("Dancing", "Gudiwada", d2, 8, 10);
		Event e3=new Event("Drawing", "Tanuku", d3, 11, 15);
